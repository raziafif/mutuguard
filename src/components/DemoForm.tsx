          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              <form onSubmit={handleSubmit} className="p-8 bg-white rounded-2xl border border-border shadow-lg">
                ...
                <button type="submit" disabled={status === "loading" || !consent} className="mt-6 w-full inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-primary rounded-xl hover:bg-primary-dark transition-all shadow-lg shadow-primary/25 disabled:opacity-60 disabled:cursor-not-allowed">
                  {status === "loading" ? (
                    <>
