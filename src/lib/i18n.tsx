...
const fr: Record<string, string> = {
  ...
  "demo.consent": "J'accepte que MutuGuard collecte et traite mes données personnelles conformément à sa",
  "demo.consentLink": "politique de confidentialité",
  "demo.gdprNote": "Vos données sont traitées conformément au RGPD. Vous pouvez exercer vos droits d'accès, de rectification et de suppression à tout moment.",
  ...
  "cookie.desc": "Ce site utilise des cookies essentiels pour son fonctionnement. Nous n'utilisons aucun cookie de suivi ou publicitaire.",
  ...
  "privacy.intro": "MutuGuard SAS (ci-après « MutuGuard », « nous ») s'engage à protéger la vie privée de ses utilisateurs conformément au Règlement Général sur la Protection des Données (RGPD - Règlement UE 2016/679). Cette politique décrit comment nous collectons, utilisons et protégeons vos données personnelles.",
  "privacy.s1.title": "Responsable du traitement",
  "privacy.s1.content": "MutuGuard SAS est responsable du traitement de vos données personnelles. Pour toute question relative à vos données, vous pouvez nous contacter à : privacy@mutuguard.com.",
  "privacy.s2.title": "Données collectées",
  "privacy.s2.content": "Nous collectons les données suivantes lorsque vous utilisez notre formulaire de démonstration :\n• Nom complet\n• Nom de l'entreprise\n• Adresse email professionnelle\n• Numéro de téléphone (optionnel)\n• Taille de l'entreprise (optionnel)\n• Message (optionnel)\n\nNous ne collectons aucune donnée sensible au sens de l'article 9 du RGPD.",
  "privacy.s3.title": "Finalités du traitement",
  "privacy.s3.content": "Vos données sont traitées pour les finalités suivantes :\n• Répondre à votre demande de démonstration\n• Vous contacter pour planifier une présentation\n• Vous fournir des informations sur nos services\n\nBase légale : votre consentement explicite (article 6.1.a du RGPD).",
  "privacy.s4.title": "Durée de conservation",
  "privacy.s4.content": "Vos données personnelles sont conservées pendant une durée maximale de 24 mois à compter de votre dernière interaction avec nous. Au-delà de cette période, vos données sont supprimées ou anonymisées.",
  "privacy.s5.title": "Vos droits",
  "privacy.s5.content": "Conformément au RGPD, vous disposez des droits suivants :\n• Droit d'accès à vos données personnelles\n• Droit de rectification des données inexactes\n• Droit à l'effacement (« droit à l'oubli »)\n• Droit à la limitation du traitement\n• Droit à la portabilité de vos données\n• Droit d'opposition au traitement\n• Droit de retirer votre consentement à tout moment\n\nPour exercer ces droits, contactez-nous à : privacy@mutuguard.com.",
  "privacy.s6.title": "Partage des données",
  "privacy.s6.content": "Nous ne vendons, ne louons et ne partageons pas vos données personnelles avec des tiers à des fins commerciales. Vos données peuvent être partagées uniquement avec nos sous-traitants techniques dans le cadre strict de la fourniture de nos services, et sous contrat conforme à l'article 28 du RGPD.",
  "privacy.s7.title": "Sécurité des données",
  "privacy.s7.content": "Nous mettons en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre tout accès non autorisé, perte, destruction ou altération, notamment :\n• Chiffrement des données en transit (TLS/SSL)\n• Contrôle d'accès strict\n• Journalisation des accès",
  "privacy.s8.title": "Réclamation",
  "privacy.s8.content": "Si vous estimez que le traitement de vos données n'est pas conforme au RGPD, vous avez le droit d'introduire une réclamation auprès de la Commission Nationale de l'Informatique et des Libertés (CNIL) : www.cnil.fr.",

  // Cookie policy
  "cookiePolicy.title": "Politique des cookies",
  "cookiePolicy.intro": "Cette politique explique comment MutuGuard utilise les cookies et technologies similaires sur son site web.",
  "cookiePolicy.s1.title": "Qu'est-ce qu'un cookie ?",
  "cookiePolicy.s1.content": "Un cookie est un petit fichier texte stocké sur votre appareil lorsque vous visitez un site web. Les cookies permettent au site de mémoriser vos actions et préférences pendant une durée déterminée.",
  "cookiePolicy.s2.title": "Cookies que nous utilisons",
  "cookiePolicy.s2.content": "MutuGuard utilise uniquement des cookies strictement nécessaires :\n\n• Cookie de consentement : mémorise votre choix concernant les cookies (localStorage). Durée : 12 mois.\n• Cookie de préférence linguistique : mémorise la langue choisie (FR/EN). Durée : session.\n\nNous n'utilisons aucun cookie de suivi, d'analyse ou publicitaire.",
  "cookiePolicy.s3.title": "Gestion des cookies",
  "cookiePolicy.s3.content": "Vous pouvez gérer vos préférences de cookies à tout moment via les paramètres de votre navigateur. La désactivation des cookies essentiels peut affecter le fonctionnement du site.",
  "cookiePolicy.s4.title": "Contact",
  "cookiePolicy.s4.content": "Pour toute question concernant notre utilisation des cookies, contactez-nous à : privacy@mutuguard.com.",
...
const en: Record<string, string> = {
  ...
  "demo.consent": "I agree that MutuGuard may collect and process my personal data in accordance with its",
  "demo.consentLink": "privacy policy",
  "demo.gdprNote": "Your data is processed in accordance with GDPR. You can exercise your rights of access, rectification, and deletion at any time.",
  ...
  "cookie.desc": "This site uses essential cookies for functionality. We do not use any tracking or advertising cookies.",
  ...
  "privacy.intro": "MutuGuard SAS (hereinafter \"MutuGuard\", \"we\") is committed to protecting the privacy of its users in compliance with the General Data Protection Regulation (GDPR - EU Regulation 2016/679). This policy describes how we collect, use, and protect your personal data.",
  "privacy.s1.title": "Data Controller",
  "privacy.s1.content": "MutuGuard SAS is the data controller for your personal data. For any questions regarding your data, you can contact us at: privacy@mutuguard.com.",
  "privacy.s2.title": "Data Collected",
  "privacy.s2.content": "We collect the following data when you use our demo request form:\n• Full name\n• Company name\n• Professional email address\n• Phone number (optional)\n• Company size (optional)\n• Message (optional)\n\nWe do not collect any sensitive data within the meaning of Article 9 of the GDPR.",
  "privacy.s3.title": "Purposes of Processing",
  "privacy.s3.content": "Your data is processed for the following purposes:\n• Responding to your demo request\n• Contacting you to schedule a presentation\n• Providing you with information about our services\n\nLegal basis: your explicit consent (Article 6.1.a of the GDPR).",
  "privacy.s4.title": "Data Retention Period",
  "privacy.s4.content": "Your personal data is retained for a maximum of 24 months from your last interaction with us. Beyond this period, your data is deleted or anonymized.",
  "privacy.s5.title": "Your Rights",
  "privacy.s5.content": "Under the GDPR, you have the following rights:\n• Right of access to your personal data\n• Right to rectification of inaccurate data\n• Right to erasure (\"right to be forgotten\")\n• Right to restriction of processing\n• Right to data portability\n• Right to object to processing\n• Right to withdraw your consent at any time\n\nTo exercise these rights, contact us at: privacy@mutuguard.com.",
  "privacy.s6.title": "Data Sharing",
  "privacy.s6.content": "We do not sell, rent, or share your personal data with third parties for commercial purposes. Your data may only be shared with our technical subprocessors strictly for the purpose of providing our services, and under contracts compliant with Article 28 of the GDPR.",
  "privacy.s7.title": "Data Security",
  "privacy.s7.content": "We implement appropriate technical and organizational measures to protect your data against unauthorized access, loss, destruction, or alteration, including:\n• Data encryption in transit (TLS/SSL)\n• Strict access controls\n• Access logging",
  "privacy.s8.title": "Complaints",
  "privacy.s8.content": "If you believe that the processing of your data is not compliant with the GDPR, you have the right to lodge a complaint with the Commission Nationale de l'Informatique et des Libertés (CNIL): www.cnil.fr.",

  // Cookie policy
  "cookiePolicy.title": "Cookie Policy",
  "cookiePolicy.intro": "This policy explains how MutuGuard uses cookies and similar technologies on its website.",
  "cookiePolicy.s1.title": "What is a cookie?",
  "cookiePolicy.s1.content": "A cookie is a small text file stored on your device when you visit a website. Cookies allow the site to remember your actions and preferences over a period of time.",
  "cookiePolicy.s2.title": "Cookies we use",
  "cookiePolicy.s2.content": "MutuGuard only uses strictly necessary cookies:\n\n• Consent cookie: remembers your cookie choice (localStorage). Duration: 12 months.\n• Language preference cookie: remembers your chosen language (FR/EN). Duration: session.\n\nWe do not use any tracking, analytics, or advertising cookies.",
  "cookiePolicy.s3.title": "Managing cookies",
  "cookiePolicy.s3.content": "You can manage your cookie preferences at any time through your browser settings. Disabling essential cookies may affect website functionality.",
  "cookiePolicy.s4.title": "Contact",
  "cookiePolicy.s4.content": "For any questions about our use of cookies, contact us at: privacy@mutuguard.com.",
